...
//    [self setOneViewController:vc image:[UIImage imageNamed:@"Page 1-1"] selImage:[UIImage imageNamed:@"Page 1-2"] title:@"发现"];
    ...
    [self setOneViewController:vc3 image:[UIImage imageNamed:@"encurage"] selImage:[UIImage imageNamed:@"encurage-selected"] title:SOLocalizedStringFromTable(@"Reward", nil)];
}
